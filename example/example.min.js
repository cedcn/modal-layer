...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalLayer = __webpack_require__(2);
	...
	var modalFade = new _modalLayer2.default('.modal-fade', {
	  effect: 'fade'
	});

	var modalSlide = new _modalLayer2.default('.modal-slide', {
	  effect: 'slide'
	});

	var modalScale = new _modalLayer2.default('.modal-scale', {
	  effect: 'scale'
	});

	(0, _jquery2.default)('.open-fade').on('click', function () {
	  modalFade.open();
	});

	(0, _jquery2.default)('.open-slide').on('click', function () {
	  modalSlide.open();
	});

	(0, _jquery2.default)('.open-scale').on('click', function () {
	  modalScale.open();
	});
